<div class="w3-content w3-display-container">
    ...
    if ($heroResult->num_rows > 0) {
        while($hrow = $heroResult->fetch_assoc()) {
            echo '<a href="?page=view&manga='.$hrow["url"].'"><img class="mySlides" src="assets/covers/'.$hrow["cover"].'" style="width:100%;height:100%" alt="wtf"></a>';
        }
    }
    ?>

    <button class="w3-button w3-black w3-display-left" onclick="plusDivs(-1)" style="border-radius:5px;width:10%;height:10%;">&#10094;</button>
