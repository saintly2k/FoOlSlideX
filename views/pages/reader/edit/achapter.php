...
<form name="wadhugdsiuhfiuh" method="POST" action="">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <a href="index.php?page=view&manga=<?php echo $manga["url"]; ?>&action=add&step=2&file=<?php echo $wtfXDD; ?>">Yeah,
                that's where my Chapter is located!</a><br><br>
            <a href="">Nope, that ain't my Chapter...</a>
        </div>
    </div>
    <?php } else { ?>
    <label for="basic-url" class="form-label">Chapter-Directory, ending WITH trailing slash!</label>
    <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon3">chapters/</span>
        <input type="text" class="form-control" name="kysxdd" id="basic-url" aria-describedby="basic-addon3">
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="chapter_title" aria-describedby="basic-addon1">
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1">Chapter (NO ZEROPADDING)</span>
                <input type="text" class="form-control" name="chapter_number" aria-describedby="basic-addon1">
            </div>
            ...
            <input type="text" name="chapter_directory" value="<?php echo $energy; ?>" style="display:none">
        </div>
        <div class="col-12">
