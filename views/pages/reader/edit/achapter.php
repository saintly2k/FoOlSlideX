...
<form name="wadhugdsiuhfiuh" method="POST" action="">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <a
                href="index.php?page=view&manga=<?php echo $manga["url"]; ?>&action=add&step=2&file=<?php echo $wtfXDD; ?>">Yeah,
...
<form name="add-chapter" method="POST" action="">
    <div class="row">
        <div class="col-12">
            <h3>Add a Chapter for <a
                    href="?page=view&manga=<?php echo $manga["url"]; ?>"><?php echo $manga["title"]; ?></a></h3>
            ...
            <input type="text" name="chapter_number"
                placeholder="[REQUIRED] Chapter Number (DON'T ZEROPAD like 02, tpye 2!!!)">
