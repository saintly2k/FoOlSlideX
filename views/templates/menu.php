            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php if(!empty($socials["twitter"])) { ?><a class="dropdown-item" href="<?php echo $socials["twitter"]; ?>" target="_blank"><i class="bi bi-twitter"></i>
                            Twitter</a><?php } ?>
                        <?php if(!empty($socials["mangadex"])) { ?><a class="dropdown-item" href="<?php echo $socials["mangadex"]; ?>" target="_blank"><i class="bi bi-book"></i>
                            MangaDex</a><?php } ?>
                        <?php if(!empty($socials["discord"])) { ?><a class="dropdown-item" href="<?php echo $socials["discord"]; ?>" target="_blank"><i class="bi bi-discord"></i>
                            Discord</a><?php } ?>
                        <?php if(!empty($socials["facebook"])) { ?><a class="dropdown-item" href="<?php echo $socials["facebook"]; ?>" target="_blank"><i class="bi bi-facebook"></i>
                            Facebook</a><?php } ?>
                        <?php if(!empty($socials["website"])) { ?><a class="dropdown-item" href="<?php echo $socials["website"]; ?>" target="_blank"><i class="bi bi-arrow-up-right-square"></i> Website</a><?php } ?>
