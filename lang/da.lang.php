...
$lang = [
    "cookie_modal" => [
        ...
        "content"   => "Denne side tillader dig at oprette en konto og gemme dine læsefremskridt der. Derfor bruger vi cookies til at gemme dine læsefremskridt. Hvis du vil bruge denne funktion, skal du acceptere os ved at bruge cookies. Vi håber du har det sjovt at læse ~",
        "accept"    => "Acceptere cookies",
        "refuse"    => "Afvis cookies"
    ],
    "install"   => [
        "title"     => "Installer FoOlSlideX",
        "confirm"   => "Let's go!",
        "after"     => "Når du har klikket på  'Let's go!', vil du blive omdirigeret til tilmeldingssiden. Tilmeld dig der ved at bruge følgende invitationskode:",
        "copy"      => "Klik for at kopiere"
    ],
    "menu" => [
        "home"      => "Forside",
        "releases"  => "Nye udgivelser",
        "titles"    => "Titler",
        "more"      => "Mere",
        "quicksearch"   => "Hurgtigsøg",
        "search"    => "Søg",
        "account"   => "Konto",
        "login"     => "Login",
        "signup"    => "Registrer",
