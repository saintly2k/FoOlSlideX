    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex px-2 py-2 xl:p-0 xl:py-1 flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="{$config.url}" class="flex items-center space-x-3 rtl:space-x-reverse" id="homeLink">
                <span
                    class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{$config.title}</span>
            </a>
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                {if $logged}
                    ...
                    <span class="text-sm">
                        <a href="{$config.url}settings"
                            class="text-blue-600 dark:text-blue-500 hover:underline">Settings</a>
                    </span>
                    {if $user.level <= 10}
                        <span class="text-sm">
                ...
                <button id="theme-toggle" type="button"
                    class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm p-2">
